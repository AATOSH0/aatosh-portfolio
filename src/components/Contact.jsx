...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-12 md:py-20 bg-gradient-to-b from-netflix-black to-netflix-dark">
        ...
        <div className="flex flex-col lg:flex-row gap-6 md:gap-12 bg-netflix-card p-4 md:p-6 lg:p-8 rounded-xl shadow-2xl">
          ...
          <div className="lg:w-3/5 mt-8 md:mt-0">
            <div className="bg-netflix-black p-4 md:p-6 lg:p-8 rounded-xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6" netlify="true" name="contactUs">
                <div className="relative">
                  <label htmlFor="name" className="block mb-1 md:mb-2 font-medium text-netflix-light-gray text-sm md:text-base">
                    Name
                  </label>
                  <input
                    type="text"
                ...
                <div className="relative">
                  <label htmlFor="email" className="block mb-1 md:mb-2 font-medium text-netflix-light-gray text-sm md:text-base">
                    Email
                  </label>
                  <input
                    type="email"
                ...
                <div className="relative">
                  <label htmlFor="message" className="block mb-1 md:mb-2 font-medium text-netflix-light-gray text-sm md:text-base">
                    Message
                  </label>
                  <textarea
                    id="message"
                ...
                <button
                  ...
                  className={`w-full bg-netflix-red hover:bg-red-700 text-white font-bold py-2 md:py-3 px-6 md:px-8 rounded transition-all duration-300 transform hover:scale-[1.02] active:scale-100 flex items-center justify-center cursor-pointer ${isSubmitting ? 'opacity-80 cursor-not-allowed' : ''} text-sm md:text-base`}
                >
                  {isSubmitting ? (
                    <>
